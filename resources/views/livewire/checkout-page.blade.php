                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model="first_name"
                                    ...
                                    id="first_name" type="text" @error('first_name') class="border-red-500" @enderror>
                                </input>
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input wire:model="last_name"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="last_name" type="text" @error('last_name') class="border-red-500" @enderror>
                                </input>
                                @error('last_name')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model="phone"
                                class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                id="phone" type="text" @error('phone') class="border-red-500" @enderror>
                            </input>
                            @error('phone')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input wire:model="street_address"
                                class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                id="address" type="text" @error('street_address') class="border-red-500" @enderror>
                            </input>
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input wire:model="city"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="city" type="text" @error('city') class="border-red-500" @enderror>
                                </input>
                                @error('city')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input wire:model="state"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="state" type="text" @error('state') class="border-red-500" @enderror>
                                </input>
                                @error('state')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input wire:model="country"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="country" type="text" @error('country') class="border-red-500" @enderror>
                                </input>
                                @error('country')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input wire:model="zip_code"
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="zip" type="text" @error('zip_code') class="border-red-500" @enderror>
                                </input>
                                @error('zip_code')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
