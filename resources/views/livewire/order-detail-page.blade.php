                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        ...
                        @if ($order->payment_status == 'paid')
                            <span class="bg-green-500 py-1 px-3 rounded text-white shadow capitalize">
                                {{ $order->payment_status }}
                            </span>
                        @elseif($order->payment_status == 'pending')
                            <span class="bg-blue-500 py-1 px-3 rounded text-white shadow capitalize">
                                {{ $order->payment_status }}
                            </span>
                        @else
                            <span class="bg-red-500 py-1 px-3 rounded text-white shadow capitalize">
                                {{ $order->payment_status }}
                            </span>
                        @endif
                    </div>
        ...
        <div class="md:w-3/4">
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p>{{ $order->address->street_address }}, {{ $order->address->city }}, {{ $order->address->state }}, {{ $order->address->zip }}</p>
                    </div>
                    <div>
