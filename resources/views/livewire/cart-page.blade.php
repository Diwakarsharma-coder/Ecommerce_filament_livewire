                                ...
                                <tr wire:key="{{ $item['product_id'] }}">
                                    <td class="py-4">
                                        <div class="flex items-center">
                                            <img class="h-16 w-16 mr-4" src="{{ asset('storage/' . $item['images'][0]) }}"
                                                alt="Product image">
                                    ...
                                    <td><button wire:click="removeFromCart({{ $item['product_id'] }})"
                                            ...
                                            <span wire:loading.remove wire:target="removeFromCart({{ $item['product_id'] }})"> Remove</span>
                                            <span wire:loading wire:target="removeFromCart({{ $item['product_id'] }})">Removing...</span>
                                        </button>
                                    </td>
                                </tr>
                            @empty
